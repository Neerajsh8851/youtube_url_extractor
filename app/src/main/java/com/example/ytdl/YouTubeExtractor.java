...
public abstract class YouTubeExtractor extends AsyncTask<String, Void, SparseArray<YtFile>> {
    ...
    protected abstract void onExtractionComplete(@Nullable SparseArray<YtFile> ytFiles, VideoMeta videoMeta);
    ...
    private void decipherViaWebView(final SparseArray<String> encSignatures) {
        ...
        new Handler(Looper.getMainLooper()).post(new Runnable() {
            ...
            @Override
            public void run() {
                new JsEvaluator(context).evaluate(stb.toString(), new com.evgenii.jsevaluator.interfaces.JsCallback() {
                    @Override
